var wed=(new Date()).getDay() == 3 || location.search.indexOf("wed=1") != -1;
...
if (queryParams.timezone) {
	dateToUse = convertTZ(dateToUse, queryParams.timezone)
}
...
if (queryParams.dadmode) {
	totalAttempts = 10
} else if (queryParams.attempts) {
	totalAttempts = parseInt(queryParams.attempts)
}

var guesses = {}
for(var currentIndex = 0; currentIndex < totalAttempts; currentIndex++) {
	guesses[currentIndex] = 0
}
...
var x = function(e) {
    ...
    return o(t, [{
        ...
        set: function(e) {
            ...
            console.log('evaluation', this.$tiles)
        }
    }, {
        key: "connectedCallback",
        value: function() {
        ...
        key: "attributeChangedCallback",
        value: function(e, a, s) {
        	console.log("attributeChangedCallback", e, a, s)
            switch (e) {
                case "letters":
                    this._letters = s || "";
                    break;
...
var Za = "IN_PROGRESS",
    ...
    ts = function(e) {
        ...
        function t() {
            ...
            var o = za();
            return e.lastPlayedTs = o.lastPlayedTs, !e.lastPlayedTs || Na(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(totalAttempts).fill(""), e.evaluations = new Array(totalAttempts).fill(null), e.solution = Da(e.today), e.dayOffset = Ga(e.today), e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.restoringFromLocalStorage = !1, ja({
                rowIndex: e.rowIndex,
        ...
        return o(t, [{
            key: "evaluateRow",
            value: function() {
                if (5 === this.tileIndex && !(this.rowIndex >= totalAttempts)) {
                    ...
                    if (e === "frogs" && wed) {
                    	document.body.innerHTML = '<video autoplay><source src="./dudes7.mp4" type="video/mp4"></video>'
                    }
                    ...
                    var i = this.rowIndex >= totalAttempts,
            ...
            value: function() {
                var e = this.shadowRoot.querySelector("#board-container"),
                    a = Math.min(Math.floor(e.clientHeight * (5 / totalAttempts)), 350),
                    s = totalAttempts * Math.floor(a / 5);
            ...
            value: function() {
                ...
                this.gameStatus === es && this.rowIndex <= totalAttempts && a.setAttribute("highlight-guess", this.rowIndex), a.gameApp = this, e.appendChild(a), e.setAttribute("open", "")
            }
        }, {
            key: "showHelpModal",
            value: function() {
            ...
            value: function() {
                ...
                this.$game.addEventListener("game-key-press", (function(a) {
                    ...
                    e.$keyboard.letterEvaluations = e.letterEvaluations, e.rowIndex < totalAttempts && (e.canInput = !0);
